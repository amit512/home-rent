		...
		?>
  		...
  		<form action="" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    <label for="plot_number">Area</label>
				    <input type="text" class="form-control" id="plot_number" placeholder="Area" name="plot_number" required>
				  </div>
				 </div>
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="rooms" placeholder="Single/Double/Flate" name="rooms" required>
				  </div>
				 </div>
			</div>
